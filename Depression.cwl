...
steps:
  ...
  somatic-depression---primary:
    run: somatic-depression---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-episode---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: somatic-depression---primary/output
  ...
  depression-psychoses---primary:
    run: depression-psychoses---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-psychoses---primary/output
class: Workflow
inputs:
  potentialCases:
    id: potentialCases
